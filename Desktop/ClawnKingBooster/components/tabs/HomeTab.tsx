...
export default function HomeTab() {
  ...
  // Listen for boost creation events to refresh INSTANTLY
  useEffect(() => {
    const handleBoostCreated = () => {
      console.log('[HomeTab] Boost created - refreshing...')
      fetchBoosts()
    }
    
    window.addEventListener('boostCreated', handleBoostCreated)
    return () => window.removeEventListener('boostCreated', handleBoostCreated)
  }, [fetchBoosts])
